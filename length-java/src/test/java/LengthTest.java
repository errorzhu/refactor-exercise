...
public class LengthTest {
    ...
    public void should_1_inch_equals_1_inch() {
        Length result = new Length(1, Unit.INCH).as(Length.INCH,Unit.INCH);
    ...
    public void should_2_feet_equals_2_feet() {
        Length result = new Length(2, Unit.FOOT).as(Length.FOOT,Unit.FOOT);
    ...
    public void should_1_yard_equals_1_yard() {
        Length result = new Length(1, Unit.YARD).as(Length.YARD,Unit.YARD);
    ...
    public void should_1_foot_equals_12_inches() {
        Length result = new Length(1, Unit.FOOT).as(Length.INCH,Unit.INCH
        );
    ...
    public void should_3_foot_equals_1_yard() {
        Length result = new Length(3, Unit.FOOT).as(Length.YARD,Unit.YARD);
    ...
    public void should_1_yard_equals_3_feet() {
        Length result = new Length(1, Unit.YARD).as(Length.FOOT,Unit.FOOT);
    ...
    public void should_1_yard_equals_36_inches() {
        Length result = new Length(1, Unit.YARD).as(Length.INCH,Unit.INCH);
    ...
    public void should_2_yards_equals_72_inches() {
        Length result = new Length(2, Unit.YARD).as(Length.INCH,Unit.INCH);
    ...
    public void should_12_inches_equals_1_foot() {
        Length result = new Length(12, Unit.INCH).as(Length.FOOT,Unit.FOOT);
    ...
    public void should_36_inches_equals_1_yard() {
        Length result = new Length(36, Unit.INCH).as(Length.YARD,Unit.YARD);
    ...
    public void should_18_inches_equals_half_yard() {
        Length result = new Length(18, Unit.INCH).as(Length.YARD,Unit.YARD);
